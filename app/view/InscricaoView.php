...
class InscricaoView extends View {
    ...
    private function getCountsSection(){
        return '<section class="dashboard-counts no-padding-bottom">
    ...
    private function getHeaderSection(){
        return '<section class="dashboard-header">
                                <div class="container-fluid">
                                  <div class="row">
                                    <!-- Statistics -->
    ...
    private function getProjectsSection(){
        return '<section class="projects no-padding-top">
                                <div class="container-fluid">
                                  <!-- Project-->
                                  <div class="project">
                                    <div class="row bg-white has-shadow">
    ...
    private function getClientSection(){
        return '<section class="client no-padding-top">
                                <div class="container-fluid">
                                  <div class="row">
                                    <!-- Work Amount  -->
                                    <div class="col-lg-4">
    ...
    private function getFeedsSection(){
        return '<section class="feeds no-padding-top">
                                <div class="container-fluid">
                                  <div class="row">
                                    <!-- Trending Articles-->
                                    <div class="col-lg-6">
    ...
    private function getUpdatesSection(){
        return '<section class="updates no-padding-top">
                                <div class="container-fluid">
                                  <div class="row">
                                    <!-- Recent Updates-->
                                    <div class="col-lg-4">
    ...
    private function getContent(){
        ...
        $msg_cargos = '<section> <div class="alert alert-success" role="alert">
                       Inscrições para a possibilidade de remanejamento interno dos servidores estatutários que assim desejem/necessitem mudança de local de exercício '
